...
AbstractKickoffItemDelegate {
    ...
    leftPadding: (KickoffSingleton.listItemMetrics?.fixedMargins.left ?? 0) + Kirigami.Units.smallSpacing
    rightPadding: (KickoffSingleton.listItemMetrics?.fixedMargins.right ?? 0) + Kirigami.Units.smallSpacing
